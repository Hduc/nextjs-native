            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
                <View style={[style.main, { marginTop: 30, backgroundColor: Colors.bg }]}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} style={{ marginTop: 10 }}>
                        ...
                        <Text style={[style.title, { color: Colors.active, textAlign: 'center' ,marginTop:40}]}>Welcome back 👋</Text>
                        ...
                        <Text style={[style.m14,{color:Colors.disable,textAlign:'center',marginTop:20}]}>Or login with</Text>
