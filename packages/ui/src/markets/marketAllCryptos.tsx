...
const MarketAllCryptos = () => {
    ...
    const [AllCryptoDataTable, setAllCryptoDataTable] = useState(AllCryptoData);
    const handleFavChecked = (id) => {
        let temp = AllCryptoDataTable.map((data,index) => {
            if (id === index) {
                return { ...data, isChecked: !data.isChecked };
            }
            return data;
        });
        setAllCryptoDataTable(temp);
    };
        ...
        <>  
            ...
            >
                ...
                <View style={{paddingHorizontal:15,width:800}}>
                    ...
                    <View style={[{
                        ...
                        <Text numberOfLines={1} style={{color:colors.text,...styles.tableItemHead}}>Name</Text>
                        <Text numberOfLines={1} style={{color:colors.text,...styles.tableItemHead}}>Price</Text>
                        <Text numberOfLines={1} style={{color:colors.text,...styles.tableItemHead}}>24h Change</Text>
                        <Text numberOfLines={1} style={{color:colors.text,...styles.tableItemHead,flexGrow:250}}>24h High / 24h Low</Text>
                        <Text numberOfLines={1} style={{color:colors.text,...styles.tableItemHead}}>24h Volume</Text>
                        <Text numberOfLines={1} style={{color:colors.text,...styles.tableItemHead}}>Market Cap</Text>
                    </View>

                    {AllCryptoDataTable.map((data,index) => {
                        return(
                            <View 
                                key={index}
                                style={{
                                ...
                                <View style={{...styles.tableItem,flexDirection:'row',alignItems:'center'}}>
                                    ...
                                    >
                                        {data.isChecked ?
                                            ...
                                            :
                                            <FontAwesome style={{opacity:.6}} color={colors.text} size={16} name='star-o'/>
                                        }
                                    </Ripple>
                                    <Image
                                        style={{
            ...
            <View style={{
                ...
                >
                    ...
                    >
                        <FeatherIcon size={14} name='chevron-left' color={colors.title}/>
                    </Ripple>
                    <Ripple
                        style={[{
                            ...styles.paginationButton,
                    ...
                    >
                        <FeatherIcon size={14} name='chevron-right' color={colors.title}/>
                    </Ripple>
                </View>
...
export default MarketAllCryptos;