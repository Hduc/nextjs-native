...
const MarketPairs = () => {
    ...
    const [MarketDataTable, setMarketDataTable] = useState(PairsData);
    const handleFavChecked = (id) => {
        let temp = MarketDataTable.map((data,index) => {
            if (id === index) {
                return { ...data, isChecked: !data.isChecked };
            }
            return data;
        });
        setMarketDataTable(temp);
    };
        ...
        <>  
            ...
            >
                ...
                <View style={{paddingHorizontal:15,width:800}}>
                    ...
                    {MarketDataTable.map((data,index) => {
                        return(
                            <View 
                                key={index}
                                style={{
